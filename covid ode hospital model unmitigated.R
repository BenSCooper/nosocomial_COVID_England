...
# K3 is for 0 community transmission and 75% reduced hospital transmission
K3<-K1
K3[1,1]<-K3[1,1]*0.25
K3[1,2]<-K3[1,2]*0.25
K3[2,2]<-K3[2,2]*0.25
...
parameters<-c(
  ...
  pi_C =0.01,
  pi_HCW =0.01,
  changepoint1=40000000, # day on which there is first change in transmission rate in the community
  changepoint2=90000000, #etc
  changepoint3=150000000,
  changepoint4=200000000,
