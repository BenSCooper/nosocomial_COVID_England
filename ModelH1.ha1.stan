//  Model H1.ha1:  covariates but no new variant or vaccine  
  data {
    ...
    real<lower=0> num_hcws[N]; //number of HCWs at trust in FTEs (not an integer)
    real<lower=0> num_hcws_std[N]; //number of HCWs at trust in FTEs rescaled so sd is 1
  }
