...
# the plot produced shows for a few trusts number of HCWs isolated due to COVID according to sitrep data
# showing this has not been recording consistently

setwd("../create_dfs/")

source("reconstructing isolating HCWs.R")
...
check_hmc_diagnostics(modelAD3.ha3)
...
check_hmc_diagnostics(modelCA3v2.ha2)
summary(modelCA3v2.ha2 ,pars=c("a0","b0","c0","sr0", "occ0","sizetrust0","agetrust0","vol", "sigmasq_a","sigmasq_k","phi0", "k0"))
summary(modelCA3v2.ha2 ,pars=c("ca_coeff","ha_coeff","sr0", "occ0","sizetrust0","agetrust0","vol","sigmasq_k","phi0", "k0","nv0"))
