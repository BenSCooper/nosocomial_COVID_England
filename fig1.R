...
# Subsequently, it may be useful to perform a sensitivity analysis with parameters for incubation period distribution for those aged >=65yrs (DOI: 10.1002/agm2.12114)
...
# total estimated with nataionlly recommended sampling based on day8-14  onset cases
